        ...
        <div class="player_info" v-if="songInfo">
            ...
            <div class="player_song_info">
                ...
                <div class="player_origin">
                    ...
                    {{ 
                        t === AudioInfoType.bili ? '哔哩哔哩' :
                        t === AudioInfoType.cloud ? '网易云音乐' :
                        t === AudioInfoType.local && songInfo.id ? 'just音乐' : '未知'
                    }}
                </div>
...
.player {
    ...
    grid-template-areas: 'info other'
                         'list .';
...
async function requesSongData() {
    ...
    loadingInfo.value = true;
    let [err, result] = props.t === AudioInfoType.cloud ? 
